...
public class SmartcanvasUrls {
    ...
    private static final String DIRECT_URL = "https://api-sandbox.smartcanvas.com/";
    ...
    public static class CardModerationUrl extends GenericUrl {
        ...
        public CardModerationUrl(boolean directUrl, String cardId) {
            super(String.format(urlUpdate, directUrl ? DIRECT_URL : DEFAULT_ROOT_URL, DEFAULT_SERVICE_PATH, cardId));
            System.out.println(directUrl);
        }

        public static CardModerationUrl of(boolean directUrl, Long cardId) {
